...
export default function ServicesSection() {
  return (
    <motion.section
      className="w-full flex flex-col items-center py-12 sm:py-16 px-4 sm:px-6 lg:px-8 bg-white dark:bg-neutral-950"
    ...
    >
      <div className="max-w-6xl mx-auto">
        <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold text-center mb-4">What We Do</h2>
          ...
          {[{
            ...
            <Card key={service.title} className="flex flex-col h-full border-0 shadow-lg hover:shadow-xl transition-shadow">
              ...
              <CardHeader className="flex-1 flex flex-col justify-start p-4 sm:p-6">
                <CardTitle className="text-lg sm:text-xl mb-2 sm:mb-3 text-[#CD9B6A]">{service.title}</CardTitle>
        ...
        <div className="text-center mt-8 sm:mt-12 px-2 sm:px-0">
          <h3 className="text-xl sm:text-2xl font-semibold mb-4 sm:mb-6 text-[#CD9B6A]">Let's Start Your Next Phaze</h3>
          <p className="text-base sm:text-lg text-neutral-700 dark:text-neutral-300 max-w-3xl mx-auto">
            Whether you're upgrading a single room or renovating an entire property, we're ready to bring your flooring vision to life. Contact us today for a free consultation and discover how we can transform your space.
          </p>
        </div>
      </div>
    </motion.section>
