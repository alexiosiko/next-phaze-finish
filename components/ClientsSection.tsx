  ...
  return (
    <section className="w-full flex flex-col items-center py-12 sm:py-16 px-4 sm:px-6 lg:px-8 bg-white dark:bg-neutral-950">
      <div className="max-w-4xl mx-auto text-center">
        ...
        <div className="mt-8 sm:mt-12 p-4 sm:p-6 bg-[#CD9B6A]/10 rounded-lg">
          <h3 className="text-lg sm:text-xl font-semibold mb-3 text-[#CD9B6A]">Personalized Service for Every Project</h3>
