  ...
  return (
    <section className="w-full flex flex-col items-center py-12 sm:py-16 px-4 sm:px-6 lg:px-8 bg-neutral-50 dark:bg-neutral-900">
      <div className="max-w-3xl mx-auto text-center">
        <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold mb-4 sm:mb-6 section-title text-[color:var(--foreground)]">About Next Phaze Finish</h2>
        
        <p className="text-lg sm:text-xl text-neutral-700 dark:text-neutral-300 mb-8 sm:mb-12 leading-relaxed px-2 sm:px-0">
          We help homeowners and businesses bring tired floors back to life — with careful preparation, honest pricing, and finishes made to last.
        </p>
        
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-6 sm:gap-8 text-center">
          <div className="space-y-3 p-4 sm:p-0">
            <h3 className="text-base sm:text-lg font-semibold text-[color:var(--accent)]">Quality Workmanship</h3>
          ...
          <div className="space-y-3 p-4 sm:p-0">
            <h3 className="text-base sm:text-lg font-semibold text-[color:var(--accent)]">Transparent Pricing</h3>
          ...
          <div className="space-y-3 p-4 sm:p-0">
            <h3 className="text-base sm:text-lg font-semibold text-[color:var(--accent)]">Personalized Service</h3>
